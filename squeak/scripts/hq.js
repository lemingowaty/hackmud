...
function Chat(msg,channel,color){
	...
	if (!msg) return "Settings Changed"
	msg = "`"+color+msg+"`"
...
switch (AR.choice){
		...
		break
		default :
		x = "`DSqueaky` \n \t `XScript` \n \t \t `KList` \n squeak.hq{choice:x} \n\n\n 1:Public Lister , arguments: {sl:digit=4,sector:string} \n 2: SQChat , arguments:{msg||channel||color}"
	}
return x
}
