function(context, args)
{
	...
	var B = #s.scripts.lib() 				// This is a library of functions delivered by seanmakesgames
	var str = "Hi, I am a string. I store text information!"
	B.log("This is a string: /n" + str)  // .log is a function of scripts.lib, it adds a new entry to an array you can retrieve later 
	var inte = 10 							// This is a standard integer number
	str = "My index is : "
	//This is an array. Arrays can contain other datatypes inside of them. 
	var arra = [
					"I'm not an array! I'm just a string inside it! \nMy index is 0, even though array.length says I have "+arra.length+" element \n You know, I feel lonely here. How about we make some friends?",
					]
	var MyNewFriends = [] 
	// Loop structure:
	...
	for (var i;i < inte;i++) //The ++ -- signs after/before an integer variable increment or decrement it by 1 
	{
		MyNewFriends[i] ="Hi! \n" + str + i
		B.log("Loop Number : " + i)
	}
	
	B.log (MyNewFriends + "\n Hang on! I'm supposed to be in there with them! Lets join them using an array method called concat..")
	...
	eobject.hex = 0xFF
	eobject.dig = 7
	if(args.myvar) {eobject.[myvar] = "Variable name defined by user!"} // args.myvar will return true if it is defined, even if it is empty/null
